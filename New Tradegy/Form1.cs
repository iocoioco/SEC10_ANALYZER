...
namespace New_Tradegy // added for test on 20241020 0300
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            dataGridView1.Rows.Add("Build Analyze Files");
            ...
            dataGridView1.Rows.Add("NQ Motion");
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            switch (e.RowIndex)
            {
                ...
                case 1:
                    RunStatAnalyzer(); // H, Z, A, Z, diff10, mul10, diff20, sum20, diff30, sum30, pro, for, ins, ind
                    break;

                case 2:
                    MulRegressionAnalyzer.RawDataForAllDates();  // RAW 생성
                    break;

                case 3:
                    int method = 5;
                    MulRegressionAnalyzer.RunSummary(method);             // 피팅 + Summary 저장
                    break;
        ...
        private static void NQLeadLagAnalysis()
        {
    ...
    debug);
        ...
        private static void RunStatAnalyzer()
        {
            // 1. 먼저 생성
